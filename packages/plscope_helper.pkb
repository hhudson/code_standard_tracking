-- The Package Body
-- Driven by queries against ALL_IDENTIFIERS, may I also point out the use of the WITH clause to improve the readability of the resulting SELECTS? Thanks to Lucas Jellema of AMIS for pointing the way!
