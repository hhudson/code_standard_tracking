...
@../views/v_ast_apex_app_auth.sql
prompt @../views/v_ast_apex_app_item_naming.sql
@../views/v_ast_apex_app_item_naming.sql
prompt @../views/v_ast_apex_html_escaping_cols.sql
@../views/v_ast_apex_html_escaping_cols.sql
prompt @../views/v_ast_apex_item_help.sql
@../views/v_ast_apex_item_help.sql
prompt @../views/v_ast_apex_page_auth.sql
@../views/v_ast_apex_page_auth.sql
prompt @../views/v_ast_apex_page_help.sql
