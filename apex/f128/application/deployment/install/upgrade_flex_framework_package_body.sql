prompt --application/deployment/install/upgrade_flex_framework_package_body
begin
--   Manifest
--     INSTALL: UPGRADE-Flex Framework package body
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(1688833137868498237)
,p_install_id=>wwv_flow_api.id(4578904365199564796)
,p_name=>'Flex Framework package body'
,p_sequence=>180
...
'                    l_sql := ''select ''||sys.dbms_assert.enquote_name(c1.lov_display_col)||'' from (''',
'                        ||sys.dbms_assert.noop(c1.lov_sql_query)',
'                        ||'') where ''||sys.dbms_assert.enquote_name(c1.lov_return_col)||'' = ''',
'                        ||sys.dbms_assert.enquote_literal(p_input);',
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(2084908081254631087)
,p_script_id=>wwv_flow_api.id(1688833137868498237)
