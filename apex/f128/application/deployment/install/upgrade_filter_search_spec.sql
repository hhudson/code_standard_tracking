prompt --application/deployment/install/upgrade_filter_search_spec
begin
--   Manifest
--     INSTALL: UPGRADE-Filter Search Spec
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(578956588259862296)
...
'begin',
'    for c1 in ( select type_name',
'                from user_types',
'                where type_name in (''EBA_STDS_FILTER_COL_TBL'') ) loop',
'        execute immediate ''drop type ''||c1.type_name;',
'    end loop;',
'end;',
'/',
'',
