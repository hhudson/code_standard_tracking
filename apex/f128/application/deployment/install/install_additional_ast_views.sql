prompt --application/deployment/install/install_additional_ast_views
begin
--   Manifest
--     INSTALL: INSTALL-Additional AST views
--   Manifest End
...
'',
'CREATE OR REPLACE FORCE VIEW "V_AST_APEX_PAGE_AUTH" ("PASS_FAIL", "PAGE_ID", "PAGE_NAME", "PAGE_ACCESS_PROTECTION", "PAGE_MODE", "PAGE_REQUIRES_AUTHENTICATION", "APPLICATION_ID") AS ',
'  select ',
