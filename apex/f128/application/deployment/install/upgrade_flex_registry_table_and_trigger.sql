prompt --application/deployment/install/upgrade_flex_registry_table_and_trigger
begin
--   Manifest
--     INSTALL: UPGRADE-Flex Registry table and trigger
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(1688829359371452547)
...
'select null',
'from user_tables',
'where table_name = ''EBA_STDS_FLEX_REGISTRY'''))
