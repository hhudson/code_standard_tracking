...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1725769764532017332)
...
,p_plug_required_role=>wwv_flow_api.id(5057645067995553528)
,p_attribute_01=>'7'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1930255227316791034)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(531127266472929224)
,p_plug_name=>'ACL Info'
,p_parent_plug_id=>wwv_flow_api.id(1930255227316791034)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(531127395661929225)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_api.id(1930255227316791034)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(531127524909929226)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(531127560987929227)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(531127642894929228)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1725769681384017331)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5057697561686996466)
...
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(5057696277139991489)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2000542518938472239)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2000567039098083569)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(2000563735588054201)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1851095649244326752)
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2343117896961335917)
,p_plug_name=>'Confirm Enabling Access Control'
,p_region_name=>'confirmEnableACL'
,p_region_template_options=>'#DEFAULT#:js-dialog-size600x400'
,p_plug_template=>wwv_flow_api.id(1851077885473326710)
,p_plug_display_sequence=>70
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2529037265831812792)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(2529035466739803594)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1851095649244326752)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_required_role=>wwv_flow_api.id(5057645067995553528)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5361117702211043627)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(5361117212884043622)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1851095649244326752)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_required_role=>wwv_flow_api.id(5057645067995553528)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6280515301848972158)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2343118003225335918)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2343117896961335917)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2343118047690335919)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2000542922524480808)
,p_name=>'P4_JOB_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2000542518938472239)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(2544893060786222181)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1371494969318267853)
,p_name=>'Access Control Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(1930255227316791034)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1371495085179267854)
,p_event_id=>wwv_flow_api.id(1371494969318267853)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1371495332912267856)
,p_name=>'Automated Testing Modal'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(2000567039098083569)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1371495352651267857)
,p_event_id=>wwv_flow_api.id(1371495332912267856)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2343118179563335920)
