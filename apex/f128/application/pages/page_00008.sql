...
,p_last_upd_yyyymmddhh24miss=>'20180129111919'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1925628322439241437)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3185077558336967097)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3185078183401983792)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1925628322439241437)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3185078371757989821)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3185082381203009379)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3185078371757989821)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(607985217975455859)
,p_name=>'P8_APPLICATION_SUBTITLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(3185077558336967097)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3185078082952978103)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(622676099772120662)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(3185078183401983792)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(622676211125120663)
,p_event_id=>wwv_flow_api.id(622676099772120662)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3185081962324006020)
...
,p_process_when_button_id=>wwv_flow_api.id(3185078371757989821)
