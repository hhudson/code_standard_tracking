...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557215621513706540)
,p_plug_name=>'Welcome to &APPLICATION_TITLE.'
,p_parent_plug_id=>wwv_flow_api.id(3557215751446706541)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557215797910706542)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557217973475706563)
,p_plug_name=>'ACL Level'
,p_parent_plug_id=>wwv_flow_api.id(3557215797910706542)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1851068919125326699)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557215941728706543)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557216058847706544)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3557218431320706568)
,p_name=>'Feature Configuration'
,p_parent_plug_id=>wwv_flow_api.id(3557216058847706544)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584856142233259423)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584856596219259423)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584856976498259423)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584857397647259424)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584857759635259424)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584858217437259424)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584858587394259425)
,p_query_column_id=>7
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557219345879706577)
,p_plug_name=>'Users'
,p_region_css_classes=>'step-container'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3557216598079706550)
,p_name=>'Users'
,p_parent_plug_id=>wwv_flow_api.id(3557219345879706577)
,p_template=>wwv_flow_api.id(1851068919125326699)
,p_display_sequence=>10
...
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_api.id(2021214125404016424)
,p_query_num_rows=>500
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_csv_output=>'N'
,p_prn_output=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584852741800259414)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584851966392259413)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584851565019259413)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584850423402259412)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1781252710411200838)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584852416451259414)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584850792697259412)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1584851164693259412)
,p_query_column_id=>8
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3557219426133706578)
,p_plug_name=>'Buttons'
,p_region_css_classes=>'step-container'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3568546715676966138)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1584853894026259416)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3557219426133706578)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1584859297901259426)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3568546715676966138)
,p_button_name=>'OK'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1584853200995259414)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3557216598079706550)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1584863584779259458)
,p_branch_name=>'Go To Page HOME'
,p_branch_action=>'f?p=&APP_ID.:HOME:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(1584853894026259416)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1584849064173259399)
,p_name=>'P1000_ACL_CONFIG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3557217973475706563)
,p_item_default=>'PUBLIC_READONLY'
,p_prompt=>'Access Control Level'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'ACCESS CONTROL SCOPE'
,p_lov=>'.'||wwv_flow_api.id(5057692965221959199)||'.'
,p_field_template=>wwv_flow_api.id(2021216092995016438)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1584849364485259406)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1584855184099259419)
,p_name=>'P1000_LOAD_SAMPLE_YN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3557215941728706543)
,p_item_default=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1584861722144259449)
,p_name=>'Refresh Users Region on Modal Close'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(1349790771803571744)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1584862218880259455)
,p_event_id=>wwv_flow_api.id(1584861722144259449)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(3557216598079706550)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1584862623308259456)
,p_name=>'Refresh on edit'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(3557216598079706550)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1584863088183259456)
,p_event_id=>wwv_flow_api.id(1584862623308259456)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1584860849443259447)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1584859718340259445)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1584860052105259446)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1584860462959259447)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1584861295533259447)
,p_process_sequence=>10
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(1584853894026259416)
