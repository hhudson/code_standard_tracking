...
,p_last_upd_yyyymmddhh24miss=>'20180129112524'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1365817644019319305)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1371495227652267855)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1925628485689241439)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1371495227652267855)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1365818074622319305)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(622675722184120658)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(1925628485689241439)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(622675794486120659)
,p_event_id=>wwv_flow_api.id(622675722184120658)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1365819659350319308)
...
,p_process_when_button_id=>wwv_flow_api.id(1365818074622319305)
,p_process_success_message=>'Automated testing job enabled.'
,p_security_scheme=>wwv_flow_api.id(5057645067995553528)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1311559309517717628)
