...
,p_last_upd_yyyymmddhh24miss=>'20180129103852'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1365852493477324184)
...
,p_plug_query_row_template=>wwv_flow_api.id(9392201307371423891)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2549041745947468121)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1365852907943324185)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2549041745947468121)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2549041924869468122)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(622675898550120660)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(2549041924869468122)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(622675975648120661)
,p_event_id=>wwv_flow_api.id(622675898550120660)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1365853253322324185)
...
,p_process_when_button_id=>wwv_flow_api.id(1365852907943324185)
,p_process_success_message=>'Automated testing job disabled.'
,p_security_scheme=>wwv_flow_api.id(5057645067995553528)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1311559141842717627)
