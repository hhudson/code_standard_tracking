...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(8090826654681872463)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1077387276192418467)
,p_plugin_id=>wwv_flow_api.id(8090826654681872463)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1077387688747418467)
,p_plugin_id=>wwv_flow_api.id(8090826654681872463)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1077388116500418468)
,p_plugin_id=>wwv_flow_api.id(8090826654681872463)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1077389091960418469)
,p_plugin_id=>wwv_flow_api.id(8090826654681872463)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(1077389781591418469)
,p_plugin_id=>wwv_flow_api.id(8090826654681872463)
