...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1858628460469743430)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2869449635469702212)
,p_plugin_id=>wwv_flow_api.id(1858628460469743430)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2869450041194702213)
,p_plugin_id=>wwv_flow_api.id(1858628460469743430)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2869450526079702213)
,p_plugin_id=>wwv_flow_api.id(1858628460469743430)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2869450879380702213)
,p_plugin_id=>wwv_flow_api.id(1858628460469743430)
,p_attribute_scope=>'COMPONENT'
