...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1857398462190831744)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2712571810236602504)
,p_plugin_id=>wwv_flow_api.id(1857398462190831744)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2712572147520602504)
,p_plugin_id=>wwv_flow_api.id(1857398462190831744)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1270227806209478545)
,p_plugin_id=>wwv_flow_api.id(1857398462190831744)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(2712573532440602505)
,p_plugin_id=>wwv_flow_api.id(1857398462190831744)
