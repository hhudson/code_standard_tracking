...
,p_group_id=>wwv_flow_api.id(5673107773021330965)
...
,p_step_template=>wwv_flow_api.id(4344933079339702900)
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_last_upd_yyyymmddhh24miss=>'20170627080252'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(4964632175855990600)
,p_name=>'&APPLICATION_TITLE.'
,p_template=>wwv_flow_api.id(4344972686088702953)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4964632257974990601)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4964632333353990602)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4964632508678990603)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7582523576652959427)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5081776154908966939)
,p_plug_name=>'About this Application'
,p_parent_plug_id=>wwv_flow_api.id(7582523576652959427)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5081777457399995621)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5081779132942998072)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5081779340562000292)
,p_plug_name=>'Support'
,p_parent_plug_id=>wwv_flow_api.id(7582523576652959427)
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7582524961649959433)
,p_plug_name=>'Help'
