...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4257208758553505099)
...
,p_plug_required_role=>wwv_flow_api.id(7589084062017041295)
,p_attribute_01=>'7'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4461694221338278801)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3062566260494416991)
,p_plug_name=>'ACL Info'
,p_parent_plug_id=>wwv_flow_api.id(4461694221338278801)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3062566389683416992)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_api.id(4461694221338278801)
...
,p_query_row_template=>wwv_flow_api.id(4382525558717814500)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3062566518931416993)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3062566555009416994)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3062566636916416995)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4257208675405505098)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7589136555708484233)
...
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(7589135271161479256)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4382534643265814519)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4531981512959960006)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4532006033119571336)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(4532002729609541968)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4382534643265814519)
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4874556890982823684)
,p_plug_name=>'Confirm Enabling Access Control'
,p_region_name=>'confirmEnableACL'
,p_region_template_options=>'#DEFAULT#:js-dialog-size600x400'
,p_plug_template=>wwv_flow_api.id(4382516879494814477)
,p_plug_display_sequence=>70
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5060476259853300559)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(5060474460761291361)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4382534643265814519)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_required_role=>wwv_flow_api.id(7589084062017041295)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7892556696232531394)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(7892556206905531389)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4382534643265814519)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_required_role=>wwv_flow_api.id(7589084062017041295)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8811954295870459925)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4874556997246823685)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(4874556890982823684)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4874557041711823686)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4531981916545968575)
,p_name=>'P4_JOB_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4531981512959960006)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5076332054807709948)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3902933963339755620)
,p_name=>'Access Control Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(4461694221338278801)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3902934079200755621)
,p_event_id=>wwv_flow_api.id(3902933963339755620)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3902934326933755623)
,p_name=>'Automated Testing Modal'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(4532006033119571336)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3902934346672755624)
,p_event_id=>wwv_flow_api.id(3902934326933755623)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4874557173584823687)
