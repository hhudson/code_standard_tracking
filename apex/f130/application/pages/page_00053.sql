...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5093828562735273987)
...
,p_list_template_id=>wwv_flow_api.id(4401366999610944984)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5096639053373826715)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5097819970938224493)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5093811365954087805)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5096639053373826715)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5093811665055087805)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5093812061618087807)
,p_branch_action=>'f?p=&APP_ID.:54:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5093811665055087805)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5093828852953285697)
,p_name=>'P53_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5093828562735273987)
,p_item_default=>'2'
,p_prompt=>'Role'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5093844751306453620)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5095155449696681546)
,p_name=>'P53_USERNAME_FORMAT1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5097819970938224493)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5095161759265844283)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3081397013088547458)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5093811365954087805)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3081397062894547459)
,p_event_id=>wwv_flow_api.id(3081397013088547458)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5094102154552099324)
...
,p_process_when_button_id=>wwv_flow_api.id(5093811665055087805)
);
