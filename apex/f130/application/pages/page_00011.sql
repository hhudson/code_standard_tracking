...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3940606416674853819)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4407986479420869534)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5040890799642118515)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3940606416674853819)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4407986897729869534)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4407986785379869534)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4407986675530869534)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3940606521484853820)
,p_branch_name=>'Branch for Deletions'
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(4407986897729869534)
,p_branch_sequence=>5
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4407987679851869536)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407987899027869539)
,p_name=>'P11_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4407986479420869534)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407988089776869551)
,p_name=>'P11_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(4407986479420869534)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407988273855869552)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407988689649869552)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407989096926869553)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407989889379869556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4407999096762057023)
,p_name=>'P11_TYPES'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(4407986479420869534)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4407989395983869554)
,p_validation_name=>'P11_DATE_STARTED must be timestamp'
,p_validation_sequence=>10
,p_validation=>'P11_DATE_STARTED'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(4407989096926869553)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3191786611500706619)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5040890799642118515)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3191786718152706620)
,p_event_id=>wwv_flow_api.id(3191786611500706619)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4407990399152869557)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4407990572939869559)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4407999190258076095)
