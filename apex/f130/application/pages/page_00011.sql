...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3959631611617489321)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4427011674363505036)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5059915994584754017)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3959631611617489321)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4427012092672505036)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4427011980322505036)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4427011870473505036)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3959631716427489322)
,p_branch_name=>'Branch for Deletions'
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(4427012092672505036)
,p_branch_sequence=>5
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4427012874794505038)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427013093970505041)
,p_name=>'P11_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4427011674363505036)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427013284719505053)
,p_name=>'P11_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(4427011674363505036)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427013468798505054)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427013884592505054)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427014291869505055)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427015084322505058)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4427024291704692525)
,p_name=>'P11_TYPES'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(4427011674363505036)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4427014590926505056)
,p_validation_name=>'P11_DATE_STARTED must be timestamp'
,p_validation_sequence=>10
,p_validation=>'P11_DATE_STARTED'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(4427014291869505055)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3210811806443342121)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5059915994584754017)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3210811913095342122)
,p_event_id=>wwv_flow_api.id(3210811806443342121)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4427015594095505059)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4427015767882505061)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4427024385200711597)
