...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7337196075909442785)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(7420554653088035413)
,p_name=>'Existing Notifications'
,p_parent_plug_id=>wwv_flow_api.id(7337196075909442785)
,p_template=>wwv_flow_api.id(4382518349641814481)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7420554955010035414)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7420555070898035415)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7420555166370035415)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7420555268277035416)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7420555371410035416)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7420555475489035416)
,p_query_column_id=>6
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7337198672168442802)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7337196479447442788)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(7337198672168442802)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7337196660551442788)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7337196863533442788)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7337196270391442786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337197061194442788)
,p_name=>'P31_DISPLAY_SEQUENCE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(7337196075909442785)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337197279444442796)
,p_name=>'P31_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(7337196075909442785)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337197449378442797)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337197650365442797)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337197856083442797)
...
,p_lov=>'.'||wwv_flow_api.id(7337200262442442809)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(3220566064800355756)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337198268183442797)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7337198455917442802)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(7337199175998442804)
,p_validation_name=>'P31_DISPLAY_FROM must be timestamp'
,p_validation_sequence=>10
,p_validation=>'P31_DISPLAY_FROM'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(7337198268183442797)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(7337199372055442806)
,p_validation_name=>'P31_DISPLAY_UNTIL must be timestamp'
,p_validation_sequence=>20
,p_validation=>'P31_DISPLAY_UNTIL'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(7337198455917442802)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4464845831664770660)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3062565901741416987)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(7337196479447442788)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3062566008130416988)
,p_event_id=>wwv_flow_api.id(3062565901741416987)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7337199477045442806)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7337199678690442807)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7337199854803442807)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(7337196660551442788)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3062565567757416984)
