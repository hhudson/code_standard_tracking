...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7374869217099540991)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(7458227794278133619)
,p_name=>'Existing Notifications'
,p_parent_plug_id=>wwv_flow_api.id(7374869217099540991)
,p_template=>wwv_flow_api.id(4420191490831912687)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7458228096200133620)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7458228212088133621)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7458228307560133621)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7458228409467133622)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7458228512600133622)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(7458228616679133622)
,p_query_column_id=>6
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7374871813358541008)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7374869620637540994)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(7374871813358541008)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7374869801741540994)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7374870004723540994)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7374869411581540992)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374870202384540994)
,p_name=>'P31_DISPLAY_SEQUENCE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(7374869217099540991)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374870420634541002)
,p_name=>'P31_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(7374869217099540991)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374870590568541003)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374870791555541003)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374870997273541003)
...
,p_lov=>'.'||wwv_flow_api.id(7374873403632541015)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(3258239205990453962)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374871409373541003)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7374871597107541008)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(7374872317188541010)
,p_validation_name=>'P31_DISPLAY_FROM must be timestamp'
,p_validation_sequence=>10
,p_validation=>'P31_DISPLAY_FROM'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(7374871409373541003)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(7374872513245541012)
,p_validation_name=>'P31_DISPLAY_UNTIL must be timestamp'
,p_validation_sequence=>20
,p_validation=>'P31_DISPLAY_UNTIL'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(7374871597107541008)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4502518972854868866)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100239042931515193)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(7374869620637540994)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100239149320515194)
,p_event_id=>wwv_flow_api.id(3100239042931515193)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7374872618235541012)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7374872819880541013)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7374872995993541013)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(7374869801741540994)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3100238708947515190)
