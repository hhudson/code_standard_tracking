...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4447122686914902111)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4438253678579317596)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_api.id(4447122686914902111)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4447228687747987502)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(4438253678579317596)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4447228992054989259)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4447228100429981672)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4447227708610974587)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4447229814254994107)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3043752387275005380)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(4447227708610974587)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3043752486832005381)
,p_event_id=>wwv_flow_api.id(3043752387275005380)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4447230293419998612)
...
,p_process_when_button_id=>wwv_flow_api.id(4447228687747987502)
,p_process_success_message=>'Sample Standard created.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4447230704502001808)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4447228992054989259)
,p_process_success_message=>'Sample Standard removed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4447230914198004629)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4447228100429981672)
