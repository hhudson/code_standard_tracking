...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4428390812344202189)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4419521804008617674)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_api.id(4428390812344202189)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4428496813177287580)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(4419521804008617674)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4428497117484289337)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4428496225859281750)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4428495834040274665)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4428497939684294185)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3025020512704305458)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(4428495834040274665)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025020612261305459)
,p_event_id=>wwv_flow_api.id(3025020512704305458)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4428498418849298690)
...
,p_process_when_button_id=>wwv_flow_api.id(4428496813177287580)
,p_process_success_message=>'Sample Standard created.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4428498829931301886)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4428497117484289337)
,p_process_success_message=>'Sample Standard removed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4428499039627304707)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4428496225859281750)
