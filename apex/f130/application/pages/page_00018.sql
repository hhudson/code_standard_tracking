...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4465936010899313716)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4457067002563729201)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_api.id(4465936010899313716)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4466042011732399107)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(4457067002563729201)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4466042316039400864)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4466041424414393277)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4466041032595386192)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4466043138239405712)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3062565711259416985)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(4466041032595386192)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3062565810816416986)
,p_event_id=>wwv_flow_api.id(3062565711259416985)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4466043617404410217)
...
,p_process_when_button_id=>wwv_flow_api.id(4466042011732399107)
,p_process_success_message=>'Sample Standard created.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4466044028486413413)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4466042316039400864)
,p_process_success_message=>'Sample Standard removed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4466044238182416234)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4466041424414393277)
