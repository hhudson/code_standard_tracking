...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3101878686812832096)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3101878785099832097)
,p_name=>'P700_TEST_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(3101878686812832096)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3101878879719832098)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3641683884202818495)
