...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3670557041561910866)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5555261480295822158)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3025360603624093980)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3670557041561910866)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3025360168466093978)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3196683489891643976)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3025361280123093982)
,p_name=>'P35_AC_ENABLED'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5555261480295822158)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3025361727626093983)
...
,p_lov=>'.'||wwv_flow_api.id(3025370666421094003)||'.'
,p_field_template=>wwv_flow_api.id(3183021159883244229)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3025362119832093983)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3025362500782093983)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3025364774363093994)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025365249704093994)
,p_event_id=>wwv_flow_api.id(3025364774363093994)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025365763822093995)
,p_event_id=>wwv_flow_api.id(3025364774363093994)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3025367101165093995)
,p_name=>'APPLY CHANGES WHEN AC ENABLED'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(3025360603624093980)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025367612169093996)
,p_event_id=>wwv_flow_api.id(3025367101165093995)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3025367957409093996)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025368507719093996)
,p_event_id=>wwv_flow_api.id(3025367957409093996)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025369008888093997)
,p_event_id=>wwv_flow_api.id(3025367957409093996)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3025369405914093997)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025369895546093997)
,p_event_id=>wwv_flow_api.id(3025369405914093997)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3025366193915093995)
,p_name=>'Cancel Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(3025360168466093978)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3025366710091093995)
,p_event_id=>wwv_flow_api.id(3025366193915093995)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3025363546429093992)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3025363996940093993)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3025364382518093993)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3025363155904093992)
