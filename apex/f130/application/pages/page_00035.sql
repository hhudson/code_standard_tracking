...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3745775381307120599)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5630479820041031891)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3100578943369303713)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3745775381307120599)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3100578508211303711)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3271901829636853709)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3100579619868303715)
,p_name=>'P35_AC_ENABLED'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5630479820041031891)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3100580067371303716)
...
,p_lov=>'.'||wwv_flow_api.id(3100589006166303736)||'.'
,p_field_template=>wwv_flow_api.id(3258239499628453962)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3100580459577303716)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3100580840527303716)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100583114108303727)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100583589449303727)
,p_event_id=>wwv_flow_api.id(3100583114108303727)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100584103567303728)
,p_event_id=>wwv_flow_api.id(3100583114108303727)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100585440910303728)
,p_name=>'APPLY CHANGES WHEN AC ENABLED'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(3100578943369303713)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100585951914303729)
,p_event_id=>wwv_flow_api.id(3100585440910303728)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100586297154303729)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100586847464303729)
,p_event_id=>wwv_flow_api.id(3100586297154303729)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100587348633303730)
,p_event_id=>wwv_flow_api.id(3100586297154303729)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100587745659303730)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100588235291303730)
,p_event_id=>wwv_flow_api.id(3100587745659303730)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100584533660303728)
,p_name=>'Cancel Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(3100578508211303711)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100585049836303728)
,p_event_id=>wwv_flow_api.id(3100584533660303728)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3100581886174303725)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3100582336685303726)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3100582722263303726)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3100581495649303725)
