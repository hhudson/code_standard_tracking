...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8774407291044342787)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8774450995606741453)
...
,p_list_id=>wwv_flow_api.id(8774450399631733169)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4344989444710702992)
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(8774411210106367249)
