...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8830781902252584768)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8830825606814983434)
...
,p_list_id=>wwv_flow_api.id(8830825010839975150)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4401364055918944973)
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(8830785821314609230)
