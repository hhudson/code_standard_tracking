...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3953989823631545659)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5137179076101689596)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3953990238097545660)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5137179076101689596)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5137179255023689597)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3210813228704342135)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5137179255023689597)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3210813305802342136)
,p_event_id=>wwv_flow_api.id(3210813228704342135)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3953990583476545660)
...
,p_process_when_button_id=>wwv_flow_api.id(3953990238097545660)
,p_process_success_message=>'Automated testing job disabled.'
,p_security_scheme=>wwv_flow_api.id(7645782398149775003)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3899696471996939102)
