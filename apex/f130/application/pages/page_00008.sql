...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4419522117905617677)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5678971353803343337)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5678971978868360032)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4419522117905617677)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5678972167224366061)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5678976176669385619)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5678972167224366061)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3101879013441832099)
,p_name=>'P8_APPLICATION_SUBTITLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5678971353803343337)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5678971878419354343)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3116569895238496902)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5678971978868360032)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3116570006591496903)
,p_event_id=>wwv_flow_api.id(3116569895238496902)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5678975757790382260)
...
,p_process_when_button_id=>wwv_flow_api.id(5678972167224366061)
