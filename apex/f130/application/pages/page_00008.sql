...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4457067316460729204)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5716516552358454864)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5716517177423471559)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4457067316460729204)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5716517365779477588)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5716521375224497146)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5716517365779477588)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3139424211996943626)
,p_name=>'P8_APPLICATION_SUBTITLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5716516552358454864)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5716517076974465870)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3154115093793608429)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5716517177423471559)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3154115205146608430)
,p_event_id=>wwv_flow_api.id(3154115093793608429)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5716520956345493787)
...
,p_process_when_button_id=>wwv_flow_api.id(5716517365779477588)
