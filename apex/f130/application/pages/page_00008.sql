...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4438253992476317599)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5697703228374043259)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5697703853439059954)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4438253992476317599)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5697704041795065983)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5697708051240085541)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5697704041795065983)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3120610888012532021)
,p_name=>'P8_APPLICATION_SUBTITLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5697703228374043259)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5697703752990054265)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3135301769809196824)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5697703853439059954)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3135301881162196825)
,p_event_id=>wwv_flow_api.id(3135301769809196824)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5697707632361082182)
...
,p_process_when_button_id=>wwv_flow_api.id(5697704041795065983)
