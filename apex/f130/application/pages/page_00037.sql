...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5852978919227708615)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4041241337491423016)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5852978919227708615)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4041241729112423017)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4041244449783423038)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(4041241337491423016)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4041242164485423017)
,p_name=>'P37_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5852978919227708615)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4041242475167423022)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3100239210796515195)
,p_name=>'Cancel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(4041241337491423016)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3100239347900515196)
,p_event_id=>wwv_flow_api.id(3100239210796515195)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4041243870116423036)
...
,p_process_when_button_id=>wwv_flow_api.id(4041241729112423017)
,p_process_success_message=>'Application appearance settings updated successfully.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4041243599787423036)
