...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5834135190690740863)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4022397608954455264)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5834135190690740863)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4022398000575455265)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4022400721246455286)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(4022397608954455264)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4022398435948455265)
,p_name=>'P37_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5834135190690740863)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4022398746630455270)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3081395482259547443)
,p_name=>'Cancel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(4022397608954455264)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3081395619363547444)
,p_event_id=>wwv_flow_api.id(3081395482259547443)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4022400141579455284)
...
,p_process_when_button_id=>wwv_flow_api.id(4022398000575455265)
,p_process_success_message=>'Application appearance settings updated successfully.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4022399871250455284)
