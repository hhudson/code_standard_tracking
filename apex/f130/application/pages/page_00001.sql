...
,p_group_id=>wwv_flow_api.id(5691839748631031230)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3919903574741619391)
,p_name=>'Dashboard'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3919904075996619396)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3919904196642619397)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3919904244790619398)
,p_query_column_id=>3
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(4512174303457691349)
,p_name=>'Applications'
,p_template=>wwv_flow_api.id(4363708274009402884)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512174592691691372)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512174693166691379)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512174812110691379)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512174885872691379)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512174995935691379)
,p_query_column_id=>5
,p_column_alias=>'TYPE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512175088065691379)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512175208991691379)
,p_query_column_id=>7
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(4512176495192717349)
,p_name=>'Standards'
,p_template=>wwv_flow_api.id(4363708274009402884)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512176809505717352)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512176887762717352)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4512177011605717352)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2963380027499176847)
,p_query_column_id=>4
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4783066930468875984)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4783071253795876027)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5594323956440787386)
...
,p_fixed_header=>'NONE'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_api.id(4533839367170092584)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5594324253140787391)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4834637651514132338)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4834638067001132340)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4834638446054132340)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4834638844663132340)
,p_query_column_id=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7582458526445072548)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4093195445671592380)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5625559654713840561)
,p_name=>'P1_TIMEZONE_URL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(7582458526445072548)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5625559847381844037)
,p_name=>'P1_TIMEZONE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(7582458526445072548)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(8793143288833068384)
