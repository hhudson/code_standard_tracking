...
,p_group_id=>wwv_flow_api.id(5767351408748176543)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3995415234858764704)
,p_name=>'Dashboard'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3995415736113764709)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3995415856759764710)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3995415904907764711)
,p_query_column_id=>3
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(4587685963574836662)
,p_name=>'Applications'
,p_template=>wwv_flow_api.id(4439219934126548197)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686252808836685)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686353283836692)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686472227836692)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686545989836692)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686656052836692)
,p_query_column_id=>5
,p_column_alias=>'TYPE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686748182836692)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587686869108836692)
,p_query_column_id=>7
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(4587688155309862662)
,p_name=>'Standards'
,p_template=>wwv_flow_api.id(4439219934126548197)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587688469622862665)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587688547879862665)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4587688671722862665)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3038891687616322160)
,p_query_column_id=>4
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4858578590586021297)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4858582913913021340)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5669835616557932699)
...
,p_fixed_header=>'NONE'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_api.id(4609351027287237897)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5669835913257932704)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4910149311631277651)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4910149727118277653)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4910150106171277653)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(4910150504780277653)
,p_query_column_id=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7657970186562217861)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4168707105788737693)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5701071314830985874)
,p_name=>'P1_TIMEZONE_URL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(7657970186562217861)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5701071507498989350)
,p_name=>'P1_TIMEZONE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(7657970186562217861)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(8868654948950213697)
