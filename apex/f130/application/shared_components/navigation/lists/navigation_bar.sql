...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(4357687340175036740)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4357687895763036777)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4357688214356036777)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4357688519575036777)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Preferences'
,p_list_item_link_target=>'f?p=&APP_ID.:36:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-heart-o'
,p_parent_list_item_id=>wwv_flow_api.id(4357688214356036777)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3966028679271226564)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3966029004287229560)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4357688813006036777)
