...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3950296110658922817)
,p_name=>'Navigation'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3950296226587922820)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3950296280819922823)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3950296423868922823)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3950296526931922823)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10353281599074480922)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Page Views'
,p_list_item_link_target=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_api.id(3950296526931922823)
,p_list_text_01=>'Interactive report of page views per user.'
,p_list_text_02=>'reportIcon'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10353289003922482364)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(9271293688583121375)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4496552877583542482)
