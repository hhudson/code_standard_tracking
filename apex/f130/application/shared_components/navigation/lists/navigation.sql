...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3931452382121955065)
,p_name=>'Navigation'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3931452498050955068)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3931452552282955071)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3931452695331955071)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3931452798394955071)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10334437870537513170)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Page Views'
,p_list_item_link_target=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_api.id(3931452798394955071)
,p_list_text_01=>'Interactive report of page views per user.'
,p_list_text_02=>'reportIcon'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10334445275385514612)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(9252449960046153623)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4477709149046574730)
