...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3893809645484413006)
,p_name=>'Navigation'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3893809761413413009)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3893809815645413012)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3893809958694413012)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3893810061757413012)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10296795133899971111)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Page Views'
,p_list_item_link_target=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_api.id(3893810061757413012)
,p_list_text_01=>'Interactive report of page views per user.'
,p_list_text_02=>'reportIcon'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10296802538747972553)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(9214807223408611564)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4440066412409032671)
