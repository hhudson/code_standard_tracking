...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3912622969468824611)
,p_name=>'Navigation'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3912623085397824614)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3912623139629824617)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3912623282678824617)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3912623385741824617)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10315608457884382716)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Page Views'
,p_list_item_link_target=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_api.id(3912623385741824617)
,p_list_text_01=>'Interactive report of page views per user.'
,p_list_text_02=>'reportIcon'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10315615862732384158)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(9233620547393023169)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4458879736393444276)
