...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(27253011600926511885)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3870812882585259062)
,p_plugin_id=>wwv_flow_api.id(27253011600926511885)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3870813329162259062)
,p_plugin_id=>wwv_flow_api.id(27253011600926511885)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3870813670970259063)
,p_plugin_id=>wwv_flow_api.id(27253011600926511885)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(3870814367232259066)
,p_plugin_id=>wwv_flow_api.id(27253011600926511885)
