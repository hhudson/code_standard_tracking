...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(27234279726355811963)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3852081008014559140)
,p_plugin_id=>wwv_flow_api.id(27234279726355811963)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3852081454591559140)
,p_plugin_id=>wwv_flow_api.id(27234279726355811963)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3852081796399559141)
,p_plugin_id=>wwv_flow_api.id(27234279726355811963)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(3852082492661559144)
,p_plugin_id=>wwv_flow_api.id(27234279726355811963)
