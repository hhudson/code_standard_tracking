...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(4352522255936119670)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5363343430936078452)
,p_plugin_id=>wwv_flow_api.id(4352522255936119670)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5363343836661078453)
,p_plugin_id=>wwv_flow_api.id(4352522255936119670)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5363344321546078453)
,p_plugin_id=>wwv_flow_api.id(4352522255936119670)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5363344674847078453)
,p_plugin_id=>wwv_flow_api.id(4352522255936119670)
,p_attribute_scope=>'COMPONENT'
