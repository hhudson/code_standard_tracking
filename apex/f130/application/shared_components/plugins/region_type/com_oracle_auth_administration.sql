...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(4390067454491231197)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5400888629491189979)
,p_plugin_id=>wwv_flow_api.id(4390067454491231197)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5400889035216189980)
,p_plugin_id=>wwv_flow_api.id(4390067454491231197)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5400889520101189980)
,p_plugin_id=>wwv_flow_api.id(4390067454491231197)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5400889873402189980)
,p_plugin_id=>wwv_flow_api.id(4390067454491231197)
,p_attribute_scope=>'COMPONENT'
