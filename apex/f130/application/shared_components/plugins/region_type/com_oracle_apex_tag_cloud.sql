...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(10584720450148248703)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3571281071658794707)
,p_plugin_id=>wwv_flow_api.id(10584720450148248703)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3571281484213794707)
,p_plugin_id=>wwv_flow_api.id(10584720450148248703)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3571281911966794708)
,p_plugin_id=>wwv_flow_api.id(10584720450148248703)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(3571282887426794709)
,p_plugin_id=>wwv_flow_api.id(10584720450148248703)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(3571283577057794709)
,p_plugin_id=>wwv_flow_api.id(10584720450148248703)
