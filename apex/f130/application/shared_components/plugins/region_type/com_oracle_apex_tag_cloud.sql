...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(10678963984836093938)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3665524606346639942)
,p_plugin_id=>wwv_flow_api.id(10678963984836093938)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3665525018901639942)
,p_plugin_id=>wwv_flow_api.id(10678963984836093938)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3665525446654639943)
,p_plugin_id=>wwv_flow_api.id(10678963984836093938)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(3665526422114639944)
,p_plugin_id=>wwv_flow_api.id(10678963984836093938)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(3665527111745639944)
,p_plugin_id=>wwv_flow_api.id(10678963984836093938)
